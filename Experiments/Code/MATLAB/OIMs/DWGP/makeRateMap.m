function [ratemap,bm,cf] = makeRateMap(x,fs,lowcf,highcf,numchans,frameshift,ti,compression, outermiddle, reflevel)
...
%
% Author: Martin Cooke
% modified by Yan Tang in 09/09/2010
...
%     u = filter([1 4*a a^2 0],[1 0],p);                % filter: part 2
    ...
    u = filter([1 4*a a^2 0], [1 -4*a 6*a^2 -4*a^3 a^4], q);
