...
def create_plp(hcopy_config) :
	os.system('/home/chasea2/SPEECH/Dissertation_Work/Experiments/Code/forcedAlignment/htk/HTKTools/HCopy -T 1 -C ' + hcopy_config + ' -S ./tmp/codetr.scp')
	
def viterbi(input_mlf, word_dictionary, output_mlf, phoneset, hmmdir) :
	os.system('/home/chasea2/SPEECH/Dissertation_Work/Experiments/Code/forcedAlignment/htk/HTKTools/HVite -T 1 -a -m -I ' + input_mlf + ' -H ' + hmmdir + '/macros -H ' + hmmdir + '/hmmdefs  -S ./tmp/test.scp -i ' + output_mlf + ' -p 0.0 -s 5.0 ' + word_dictionary + ' ' + phoneset + ' > ./tmp/aligned.results')
